...
namespace Depot.Business.Models.Validations.Documentos
{
    ...
    public class DigitoVerificador
    {
        ...
        public DigitoVerificador ComMultiplicadorDeAte(int primeiroMultiplicador, int ultimoMultiplicador)
        {
